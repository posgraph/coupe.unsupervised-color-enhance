...
parser.add_argument('--dataset_root', dest='dataset_root', default='./datasets', help='path of the dataset')
...
parser.add_argument('--model_dir', dest='model_dir', default='color_enhance', help='models are saved here')
